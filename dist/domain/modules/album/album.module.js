...
const album_provider_1 = require("./album.provider");
...
AlbumModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [...album_provider_1.albumProviders, album_service_1.AlbumService],
        exports: [...album_provider_1.albumProviders, album_service_1.AlbumService],
    })
], AlbumModule);
