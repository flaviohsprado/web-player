...
let PlaylistController = class PlaylistController {
    ...
    async create(file, createPlaylistDTO) {
        const playlist = await new playlist_dto_1.PlaylistDTO(createPlaylistDTO);
        return this.playlistService.create(playlist, file);
    }
    async update(file, id, playlist) {
        const updatePlaylist = await new playlist_dto_1.PlaylistDTO(playlist, id);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Array, playlist_dto_1.PlaylistDTO]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Array, String, playlist_dto_1.PlaylistDTO]),
    __metadata("design:returntype", Promise)
...
PlaylistController = __decorate([
    (0, common_1.Controller)('public/playlists'),
